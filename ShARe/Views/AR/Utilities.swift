...
//  ShARe
//
//  This is an implementation found in Apple's publicly available 'CollaborativeSession' sample
//  Please view the original sample for further documentation and explanations
//
