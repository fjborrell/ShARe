...
//  ShARe
//
//  This is an implementation of MultipeerConnectivity from Apple's publicly available samples
//  with slight custom adjustments. Please view the originals for further documentation and explanations.
//
